...
public class Product {
	...
	@JoinColumn(name = "features_id") // to give a diff column otherwise  features_features_id;
	private Features features;
	
	@OneToMany(cascade = CascadeType.ALL)
	@JoinColumn(name = "product_id") //product_id add to offers table
